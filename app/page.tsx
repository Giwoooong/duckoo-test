  ...
  return (
    <div className="shell">
      <main className="hero">
        ...
        {/* 인터랙티브 테스트 카드 영역 (Client Component) */}
        <HomeClient />

        {/* ── 여기부터 SSR: 구글봇이 JS 없이 읽는 텍스트 ── */}
        ...
        {/* FAQ Section — SSR details + Client accordion */}
        <section className="faq-section">
          <div className="section-header">
            <h2>자주 묻는 질문 (FAQ)</h2>
            <p className="lead">덕후테스트 이용에 대한 궁금증을 해결해 드립니다.</p>
          </div>
          {/* SSR: details/summary — 봇과 noscript용 */}
        ...
        <section className="upcoming-section">
          ...
          <div className="infoList">
            <article className="upcoming-card">
              <div className="upcoming-icon naruto-icon">✱</div>
            ...
            <article className="upcoming-card">
              <div className="upcoming-icon hp-icon">🪄</div>
              <div className="upcoming-content">
                <h3>해리포터 마법사 테스트</h3>
            ...
            <article className="upcoming-card">
              <div className="upcoming-icon" style={{ background: 'linear-gradient(135deg, #e53935, #b71c1c)', color: 'white', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>🎬</div>
              <div className="upcoming-content">
                <h3>블리치 덕후 테스트</h3>
